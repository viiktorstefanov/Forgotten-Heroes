...
export const gamePurposeInfo = {
    ...
    description: 'Вашата цел е да отговорите правилно на всички въпроси от съответното ниво и да събирате точки, като същевременно научавате интересни факти за личности и събития от българската история.'
};
...
export const heroesSection = {
    ...
    description: 'Тази секция представя значимите фигури в българската история, обхващащи периодите на Средновековието, Възраждането и Новото време. Тук ще намерите информация за великите личности, които са допринесли за формирането и развитието на българската държава и култура през различните исторически епохи.'
};
